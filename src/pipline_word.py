...
#load data
x = pd.read_csv('dataset\w2v.txt',header=None,sep=' ',names = ['vec'])
y = pd.read_csv('./TA_label.txt',names=['label'])

x = np.float32(x['vec'].to_numpy())
...
file_path = "./dataset/BiLSTM_word.txt"
